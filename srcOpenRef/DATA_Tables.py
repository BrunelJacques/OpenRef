...
DB_TABLES = {
    ...
    '_Ateliers' : [
        ...
        ("CalculAutreProduit",  'mediumtext', '  ', "Liste de Tuples (radicalCompte, prorata) pour déterminer la valeur autre produit par défaut"),
        ("Subventions",  'float', ' DEFAULT NULL', " Valeur calculée ou forcée des subventions affectées à l'atelier"),
        ("CalculSubvention",  'mediumtext', '  ', "Liste de Tuples (radicalCompte, prorata) pour déterminer la valeur des subventions affectées à l'atelier"),
        ("Comm",  'float', ' DEFAULT NULL,', ''),
        ("CalculComm",  'mediumtext', '  ', "Liste de Tuples (radicalCompte, prorata) pour déterminer la valeur de la commercialisation non détaillée dans les coûts"),
        ("Conditionnement",  'float', ' DEFAULT NULL,', ''),
        ("CalculConditionnement",  'mediumtext', '  ', "Liste de Tuples (radicalCompte, prorata) pour déterminer la valeur du conditionnement non détaillé dans les coûts"),
        ("AutresAppros",  'float', ' DEFAULT NULL,', ''),
        ("CalculAppros",  'mediumtext', '  ', " Liste de Tuples (radicalCompte, prorata) pour déterminer la valeur de l'approvisionnement non détaillé dans les coûts"),
        ("AutresServices",  'float', ' DEFAULT NULL,', ''),
        ("CalculServices",  'mediumtext', '  ', " Liste de Tuples (radicalCompte, prorata) pour déterminer la valeur des services extérieurs non détaillé dans les coûts"),
        ("AmosSpécif",  'float', ' DEFAULT NULL,', ''),
        ("CalculAmosSpécif",  'mediumtext', '  ', " Liste de Tuples (radicalCompte, prorata) pour déterminer la valeur de l'amortissement spécifique à l'atelier non détaillé dans les coûts"),
    ...
    '_Coûts' : [
        ...
        ("ProrataComptes",  'varchar(128)', ' DEFAULT NULL', "Liste de prorata avec autant d'occurences que celle des comptes"),
    ...
    '_Ident' : [
        ...
        ("AnalyseProduction",  'mediumblob', '  ', "Ce commentaire sur la production reprendra dans un premier temps la récupération du descriptif de l'exploitation dans la compta."),
        ("AnalyseFinances",  'mediumblob', '  ', "Commentaire appuyant l'analyse par le tableau de financement"),
        ("Perspectives",  'mediumblob', '  ', "Analyse générale à adjoindre à celle du tableau de financement. Les trois analyses ont vocation à être concaténées dans les documents de présentation des comptes"),
    ...
    '_Produits' : [
        ...
        ("ProrataComptes",  'varchar(128)', ' DEFAULT NULL', "Prorata de l'affectation des comptes pour le calcul du produit (100% par défaut)"),
