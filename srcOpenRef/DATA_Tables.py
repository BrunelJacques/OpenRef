...
DB_TABLES = {
    ...
    '_Balances': [
        ...
        ("Compte", 'varchar(10)', 'NOT NULL', "Compte comptable avec 401, 411 et 42 regroupés"),
        ("IDligne", 'int(11)', 'NOT NULL', "Permet plusieurs lignes d''un même compte"),
        ("Libellé", 'varchar(64)', 'DEFAULT NULL', ""),
        ("MotsCléPrés", 'varchar(500)', 'NOT NULL',"Liste des mots clés dans le libellé ou le top ten écritures, lors de l''import"),
        ("Quantités1", 'float', 'DEFAULT NULL', ""),
        ("Unité1", 'varchar(8)', 'DEFAULT NULL', "Unité des quantités telle que proposé dans la compta pour ce compte"),
        ("Quantités2", 'float', 'DEFAULT NULL', "Si deux saisies de quantités sont possibles"),
        ("Unité2", 'varchar(8)', 'DEFAULT NULL',""),
        ("SoldeDeb", 'float', 'DEFAULT NULL', "Respecte la règle d''un seul sens Débit ou Crédit en valeur négative"),
        ("DBmvt", 'float', 'DEFAULT NULL', "Cumul des débits Hors à nouveau"),
        ...
        ("Affectation", 'varchar(48)', "NOT NULL DEFAULT ' '",
                        "P.IDMatelier.IDMproduit, C.IDMatelier.IDMcoût,A.IDMatelier.poste,I.TabFin " +
                                                              ": désigne où est l''affection et le mode de calcul"),
        ],
    '_Ateliers': [
    ...
    '_Coûts' : [
        ...
        ("Comptes",  'varchar(500)', ' DEFAULT NULL', "Liste des radicaux des comptes entrant dans le calcul de la charge, éventuellement préfixé d'un signe"),
    ...
    '_Produits' : [
        ...
        ("Comptes",  'varchar(500)', ' DEFAULT NULL', "Liste des comptes retenus dans le dossier (par défaut liste prise dans le modèle)"),
