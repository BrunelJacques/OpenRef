...
class PreviewControlBar(wx.PyPreviewControlBar):
    def __init__(self, preview, buttons, parent):
        ...
        # Impression
        self.staticbox_impression_staticbox = wx.StaticBox(self, -1, "Impression")
        self.bouton_imprimer = wx.BitmapButton(self,
                                               wx.ID_PREVIEW_PRINT,
                                               wx.Bitmap("Images/32x32/Imprimante.png", wx.BITMAP_TYPE_ANY),
                                               size=(80, -1))

        # Impression rapide
        self.staticbox_rapide_staticbox = wx.StaticBox(self, -1, "Impression rapide")
        ...
        # Navigation
        self.staticbox_navigation_staticbox = wx.StaticBox(self,
                                                           -1,
                                                           "Navigation")
        self.bouton_premier = wx.BitmapButton(self,
                                              wx.ID_PREVIEW_FIRST,
                                              wx.Bitmap("Images/32x32/Premier.png", wx.BITMAP_TYPE_ANY))
        self.bouton_precedent = wx.BitmapButton(self,
                                                wx.ID_PREVIEW_PREVIOUS,
                                                wx.Bitmap("Images/32x32/Precedent.png", wx.BITMAP_TYPE_ANY))
        self.bouton_suivant = wx.BitmapButton(self,
                                              wx.ID_PREVIEW_NEXT,
                                              wx.Bitmap("Images/32x32/Suivant.png", wx.BITMAP_TYPE_ANY))
        self.bouton_dernier = wx.BitmapButton(self, wx.ID_PREVIEW_LAST,
                                              wx.Bitmap("Images/32x32/Dernier.png", wx.BITMAP_TYPE_ANY))

        # Zoom
        self.staticbox_zoom_staticbox = wx.StaticBox(self,
                                                     -1,
                                                     "Zoom")
        self.bouton_zoom_moins = wx.BitmapButton(self,
                                                 -1,
                                                 wx.Bitmap("Images/32x32/zoom_moins.png", wx.BITMAP_TYPE_ANY))
...
class PreviewFrame(wx.PyPreviewFrame):
    def __init__(self, preview, parent, title="Aperçu avant impression", orientation=wx.PORTRAIT):
...
class ObjectListViewPrinter(object):
    ...
    def InitParametres(self):
        ...
        # Titre de liste
        fmt.ListHeader.Font = wx.Font(dictOptions["titre_taille_texte"], wx.SWISS, wx.NORMAL,
                                      dictOptions["titre_style"], faceName="Arial")
        ...
        # Titre de colonne
        fmt.ColumnHeader.Font = wx.Font(dictOptions["titre_colonne_taille_texte"], wx.SWISS, wx.NORMAL,
                                        dictOptions["titre_colonne_style"], faceName="Arial")
        ...
        fmt.ListFooter.Font = wx.Font(dictOptions["conclusion_taille_texte"], wx.SWISS, wx.NORMAL,
                                      dictOptions["conclusion_style"], faceName="Arial")
...
class FramePreview(wx.Frame):
    def __init__(self, parent, title="", printPreview=None):
        ...
        self.bouton_precedent = wx.BitmapButton(self.panel, -1,
                                                wx.Bitmap("Images/32x32/Precedent.png", wx.BITMAP_TYPE_ANY))
