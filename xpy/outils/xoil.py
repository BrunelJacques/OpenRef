...
# ------------------------------------------------------------------------
# xoil.py (options impression listes)
...
class CTRL_Parametres(CTRL_Propertygrid.CTRL):
    ...
    def Remplissage(self):
        ...
        # Inclure les images
        propriete = wxpg.BoolProperty(label="Inclure les images", name="inclure_images", value=True)
        propriete.SetHelpString("Cochez cette case pour inclure les images")
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Entete de colonne sur chaque page
        propriete = wxpg.BoolProperty(label="Afficher les entêtes sur chaque page", name="entetes_toutes_pages",
                                      value=True)
        propriete.SetHelpString("Cochez cette case pour afficher les entêtes de colonne sur chaque page")
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Qualité de l'impression
        labels = ["Brouillon", "Basse", "Moyenne", "Haute"]
        propriete = wxpg.EnumProperty(label="Qualité d'impression", name="qualite_impression", labels=labels,
                                      values=[wx.PRINT_QUALITY_DRAFT, wx.PRINT_QUALITY_LOW, wx.PRINT_QUALITY_MEDIUM,
                                              wx.PRINT_QUALITY_HIGH], value=wx.PRINT_QUALITY_MEDIUM)
        propriete.SetHelpString("Sélectionnez la qualité d'impression (Moyenne par défaut)")
        ...
        # Gauche
        propriete = wxpg.IntProperty(label="Gauche", name="marge_gauche", value=5)
        propriete.SetHelpString("Saisissez une taille de marge")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("marge_gauche", "SpinCtrl")

        # Droite
        propriete = wxpg.IntProperty(label="Droite", name="marge_droite", value=5)
        propriete.SetHelpString("Saisissez une taille de marge")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Haut
        propriete = wxpg.IntProperty(label="Haut", name="marge_haut", value=5)
        propriete.SetHelpString("Saisissez une taille de marge")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Bas
        propriete = wxpg.IntProperty(label="Bas", name="marge_bas", value=5)
        propriete.SetHelpString("Saisissez une taille de marge")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Epaisseur de trait
        propriete = wxpg.FloatProperty(label="Epaisseur de trait", name="grille_trait_epaisseur", value=0.25)
        propriete.SetHelpString("Saisissez une épaisseur de trait (Par défaut '0.25')")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur de trait
        propriete = wxpg.ColourProperty(label="Couleur de trait", name="grille_trait_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur de trait")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Taille police
        propriete = wxpg.IntProperty(label="Taille de texte", name="titre_taille_texte", value=16)
        propriete.SetHelpString("Saisissez une taille de texte (16 par défaut)")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        propriete = wxpg.EnumProperty(label="Style de texte", name="titre_style", labels=labels, values=valeurs,
                                      value=wx.FONTWEIGHT_BOLD)
        propriete.SetHelpString("Sélectionnez un style de texte")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur
        propriete = wxpg.ColourProperty(label="Couleur de texte", name="titre_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Alignement
        labels = ["Gauche", "Centre", "Droite"]
        propriete = wxpg.EnumProperty(label="Alignement du texte", name="titre_alignement", labels=labels,
                                      values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT], value=wx.ALIGN_LEFT)
        propriete.SetHelpString("Sélectionnez le type d'alignement")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Taille police
        propriete = wxpg.IntProperty(label="Taille de texte", name="intro_taille_texte", value=7)
        propriete.SetHelpString("Saisissez une taille de texte (7 par défaut)")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = ["Normal", "Light", "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label="Style de texte", name="intro_style", labels=labels, values=valeurs,
        ...
        # Couleur
        propriete = wxpg.ColourProperty(label="Couleur de texte", name="intro_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = ["Gauche", "Centre", "Droite"]
        propriete = wxpg.EnumProperty(label="Alignement du texte", name="intro_alignement", labels=labels,
                                      values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT], value=wx.ALIGN_LEFT)
        propriete.SetHelpString("Sélectionnez le type d'alignement")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Taille police
        propriete = wxpg.IntProperty(label="Taille de texte", name="titre_colonne_taille_texte", value=8)
        propriete.SetHelpString("Saisissez une taille de texte (8 par défaut)")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = ["Normal", "Light", "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label="Style de texte", name="titre_colonne_style", labels=labels, values=valeurs,
                                      value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString("Sélectionnez un style de texte")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Couleur
        propriete = wxpg.ColourProperty(label="Couleur de texte", name="titre_colonne_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = ["Gauche", "Centre", "Droite"]
        propriete = wxpg.EnumProperty(label="Alignement du texte", name="titre_colonne_alignement", labels=labels,
                                      values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT], value=wx.ALIGN_CENTER)
        propriete.SetHelpString("Sélectionnez le type d'alignement")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur de fond
        propriete = wxpg.ColourProperty(label="Couleur de fond", name="titre_colonne_couleur_fond",
                                        value=wx.Colour(240, 240, 240))
        propriete.SetHelpString("Sélectionnez une couleur de fond")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Taille police
        propriete = wxpg.IntProperty(label="Taille de texte", name="ligne_taille_texte", value=8)
        propriete.SetHelpString("Saisissez une taille de texte (8 par défaut)")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = ["Normal", "Light", "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label="Style de texte", name="ligne_style", labels=labels, values=valeurs,
                                      value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString("Sélectionnez un style de texte")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Couleur
        propriete = wxpg.ColourProperty(label="Couleur de texte", name="ligne_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Multilignes autorisé
        propriete = wxpg.BoolProperty(label="Autoriser saut à la ligne", name="ligne_multilignes", value=True)
        propriete.SetHelpString("Cochez cette case pour autoriser le saut à la ligne en cas de colonne trop étroite")
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        ...
        # Texte de gauche
        valeur = "{DATE_JOUR}"
        propriete = wxpg.StringProperty(label="Texte de gauche", name="pied_page_texte_gauche", value=valeur)
        ...
        propriete = wxpg.StringProperty(label="Texte du milieu", name="pied_page_texte_milieu", value=valeur)
        propriete.SetHelpString(
        ...
        propriete = wxpg.StringProperty(label="Texte de droite", name="pied_page_texte_droite", value=valeur)
        propriete.SetHelpString(
        ...
        # Taille police
        propriete = wxpg.IntProperty(label="Taille de texte", name="pied_page_taille_texte", value=8)
        propriete.SetHelpString("Saisissez une taille de texte (8 par défaut)")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = ["Normal", "Light", "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label="Style de texte", name="pied_page_style", labels=labels, values=valeurs,
                                      value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString("Sélectionnez un style de texte")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Couleur
        propriete = wxpg.ColourProperty(label="Couleur de texte", name="pied_page_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Taille police
        propriete = wxpg.IntProperty(label="Taille de texte", name="pied_colonne_taille_texte", value=8)
        propriete.SetHelpString("Saisissez une taille de texte (8 par défaut)")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = ["Normal", "Light", "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label="Style de texte", name="pied_colonne_style", labels=labels, values=valeurs,
                                      value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString("Sélectionnez un style de texte")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Couleur
        propriete = wxpg.ColourProperty(label="Couleur de texte", name="pied_colonne_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = ["Gauche", "Centre", "Droite"]
        propriete = wxpg.EnumProperty(label="Alignement du texte", name="pied_colonne_alignement", labels=labels,
                                      values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT], value=wx.ALIGN_CENTER)
        propriete.SetHelpString("Sélectionnez le type d'alignement")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Couleur de fond
        propriete = wxpg.ColourProperty(label="Couleur de fond", name="pied_colonne_couleur_fond",
                                        value=wx.Colour(240, 240, 240))
        propriete.SetHelpString("Sélectionnez une couleur de fond")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Taille police
        propriete = wxpg.IntProperty(label="Taille de texte", name="conclusion_taille_texte", value=7)
        propriete.SetHelpString("Saisissez une taille de texte (7 par défaut)")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = ["Normal", "Light", "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label="Style de texte", name="conclusion_style", labels=labels, values=valeurs,
                                      value=wx.FONTWEIGHT_BOLD)
        propriete.SetHelpString("Sélectionnez un style de texte")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Couleur
        propriete = wxpg.ColourProperty(label="Couleur de texte", name="conclusion_couleur", value=wx.BLACK)
        propriete.SetHelpString("Sélectionnez une couleur")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = ["Gauche", "Centre", "Droite"]
        propriete = wxpg.EnumProperty(label="Alignement du texte", name="conclusion_alignement", labels=labels,
                                      values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT], value=wx.ALIGN_LEFT)
        propriete.SetHelpString("Sélectionnez le type d'alignement")
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
...
class CTRL(wx.Panel):
    def __init__(self, parent, dictOptions={}):
        ...
        # Orientation
        self.box_orientation_staticbox = wx.StaticBox(self, -1, "Orientation")
        self.ctrl_radio_portrait = wx.RadioButton(self, -1, u"", style=wx.RB_GROUP)
        self.ctrl_image_portrait = wx.StaticBitmap(self, -1, wx.Bitmap(u"Images/32x32/Orientation_vertical.png",
                                                                       wx.BITMAP_TYPE_ANY))
        self.ctrl_radio_paysage = wx.RadioButton(self, -1, u"")
        self.ctrl_image_paysage = wx.StaticBitmap(self, -1, wx.Bitmap(u"Images/32x32/Orientation_horizontal.png",
                                                                      wx.BITMAP_TYPE_ANY))
...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictOptions={}):
        ...
        # Bandeau
        titre = "Paramètres d'impression"
        intro = "Vous pouvez ici modifier les paramètres d'impression par défaut des listes. Cliquez sur le bouton 'Mémoriser les paramètres' pour réutiliser les même paramètres pour toutes les autres impressions de listes."
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30,
                                                 nomImage="Images/32x32/Document_parametres.png")

        # Paramètres
        self.ctrl_parametres = CTRL(self, dictOptions=dictOptions)

        # Boutons
        self.bouton_ok = CTRL_Bouton_image.CTRL(self, texte="Ok", cheminImage="Images/32x32/Valider.png")
