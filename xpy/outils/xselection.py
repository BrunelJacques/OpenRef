...
class Dialog(wx.Dialog):
    def __init__(self, parent, listeColonnes=[], listeValeurs=[], type=None):
        wx.Dialog.__init__(self, parent, -1, title="Sélection d'éléments", size=(800, 460))
        self.parent = parent
        ...
        self.label_intro = wx.StaticText(self, -1, "Veuillez sélectionner les éléments de votre choix :")
        ...
        self.bouton_ok = xctrlbi.CTRL(self, texte="Ok", cheminImage="Images/32x32/Valider.png")
